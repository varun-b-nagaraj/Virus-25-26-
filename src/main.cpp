...
const int MAX_SPEED = 127; // Set your desired maximum speed here
    leftArm.move_absolute(0, 125);
// Create MoveToPointParams and TurnToHeadingParams objects with maxSpeed
    ...
    chassis.moveToPose(-23.306, -16.339, 90, 1500, {.forwards = false, .maxSpeed = MAX_SPEED}, false); // Turn and grab MG
    ...
    chassis.moveToPose(56.072, 7.447, 168, 2000, {.forwards = false, .maxSpeed = MAX_SPEED}, false);//push it in
    MogoMech.set_value(true);//releasing
    spinIntakeMS(800);
    chassis.moveToPose(45.765, -16.339, 90, 3000, {.forwards = true, .maxSpeed = MAX_SPEED});
    chassis.moveToPose(22.662, -16.339, 90, 2000, {.forwards = false}, false);
    MogoMech.set_value(false);//adding
    pros::delay(500);
    spinIntake();
    //---------------
    chassis.moveToPose(47.511, -39.936, 153, 3000);
    chassis.moveToPose(59.238, -63.39, 153, 3000);
    chassis.turnToHeading(210.6, 700);
    chassis.moveToPose(47.511, -87.03, 152, 3000);
    chassis.moveToPose(60.561, -110.454, 180, 3000);
    chassis.moveToPose(60.63, -122.028, 180, 3000);
    leftArm.move_absolute(220, 100); // move to position 90 with velocity 100, bringd arm down
    chassis.turnToHeading(310, 3000, {}, false);
    MogoMech.set_value(true);//releasing
    chassis.moveToPose(47.274, -110.829, 310, 3000);
    stopIntake();
