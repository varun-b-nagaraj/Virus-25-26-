...
// compute Y from left distance sensor (mm → inches + sensor→center offset
    ...
    chassis.moveToPose(-48, 48, 180, 2000, {.forwards = false, .minSpeed = 127});
    ...
    Descorer.extend();
    chassis.moveToPoint(-58, 40, 1000, {.forwards = false, .minSpeed = 40, .earlyExitRange = 2});
    chassis.turnToHeading(180, 500);
    chassis.moveToPoint(-58, 44, 1000, {.forwards = false});    
    chassis.moveToPoint(-53, 61, 2000, {.forwards = false, .minSpeed = 127});
    chassis.waitUntil(5);
    Descorer.retract();
